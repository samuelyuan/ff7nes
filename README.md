...
Decompilation of the NES version of Final Fantasy VII.

This branch handles the original Chinese ROM before any patches were made. The Advent Children patch added a lot of changes, but the disassembly of this project is to understand which parts changed.

This project builds the following rom:

* game.nes ```md5: 1b07874d73756f1ec33a957f1640153c```
